...
#
# INSERT INTO `5kcrm_crm_config` (`id`, `name`, `value`, `description`) VALUES (4, 'contract_day', '30', '合同到期提醒天数');
...
delete from `5kcrm_admin_rule` where id=75;
delete from `5kcrm_admin_rule` where id=76;
delete from `5kcrm_admin_rule` where id=77;
delete from `5kcrm_admin_rule` where id=78;
delete from `5kcrm_admin_rule` where id=79;
delete from `5kcrm_admin_rule` where id=80;
delete from `5kcrm_admin_rule` where id=81;
delete from `5kcrm_admin_rule` where id=82;
delete from `5kcrm_admin_rule` where id=83;
delete from `5kcrm_admin_rule` where id=84;
